# Guidelines for Contributing to taurus-legacy-cli
...
The taurus_legacy_cli repository uses the [GithubFlow][] branching 
...
[issue tracker]: https://github.com/taurus-org/taurus_legacy_cli/issues
